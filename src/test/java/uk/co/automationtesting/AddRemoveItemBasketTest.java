...
public class AddRemoveItemBasketTest extends Hooks {
	...
	public void addRemoveItem() throws IOException {
		...
		ExtentManager.pass("Have succesfully added product to basket");
		...
		//creating an object for the shopping cart page and deleting item2)
		...
		try {
			...
			Assert.fail("Cart amount did not match the expected amount, it foud" + cart.getTotalAmount().getText() +
					"expected $45.23");
